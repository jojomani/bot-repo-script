...
#Step 0: Intro
echo "Hi" username ", I am BRS, the Best Bot Repo Script :)"
echo "Let's get started"

#Step 1: Name of the remote repo. Enter a single word or separate using hyphens.
echo username ", What's the name of your remote repo?"
read REPO_NAME
...
echo "And ... BOOM! Done. Go to https://github.com/$USERNAME/$REPO_NAME to see your new repo :D Enjoy your Coding" username 
